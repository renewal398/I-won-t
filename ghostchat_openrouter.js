...
function mergeOptions(defaults, options) {
  ...
  var ghostChatState = {
    ...
    contextData: null,
    widgetOpen: false,
    licenseApiUrl: 'https://license-validator-1.onrender.com/api/validate-license', // Configure this
  ...
  /**
   * Send message to AI provider (OpenRouter API)
  ...
  function sendMessageToAI(message) {
    ...
    var systemContext = 'You are a helpful assistant.';
    ...
    var model = ghostChatState.config.model || 'deepseek/deepseek-chat';
  ...
  // ✅ Make initGhostChat available globally
